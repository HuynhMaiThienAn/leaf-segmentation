...
def update_final_notebook():
    ...
    new_source = [
        "# Define how to extract all channels (including lightness) for each color space\n",
        "color_spaces = {\n",
        ...
        "    \n",
        "    # 4. Polarity Correction using the color space's own reference channel\n",
        ...
        "        # In CIELAB, green leaves have low/negative a* values\n",
        "        if correlation > 0:\n",
        "            pc1 = -pc1\n",
        "    else:\n",
        "        # In RGB (Green) and HSV (Saturation), green leaves have high values\n",
        "        if correlation < 0:\n",
        "            pc1 = -pc1\n",
        "        \n",
        "    # Scale to 0-255\n",
...
def update_test_notebook():
    ...
    for cell in nb.get("cells", []):
        if cell.get("cell_type") == "code":
            ...
            if "    # Define color spaces (including lightness)" in source_str:
                new_source = [
